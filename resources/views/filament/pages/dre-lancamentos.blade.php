<x-filament-panels::page>
    ...
    <div style="margin-top:20px;display:flex;flex-direction:column;gap:12px;">
        @forelse($this->vendas as $venda)
            ...
            <div style="border-radius:10px;background:#1f2937;overflow:hidden;border:1px solid {{ $lancado ? '#065f46' : '#374151' }};{{ $lancado ? 'opacity:0.85;' : '' }}">
                {{-- Header do pedido --}}
                ...
                <table style="width:100%;font-size:12px;border-collapse:collapse;">
                    <tr style="border-bottom:1px solid #374151;">
                        <td style="padding:6px 16px;color:#10b981;font-weight:500;width:50%;">📥 Entrada (Subtotal + Frete)</td>
                        <td style="padding:6px 16px;text-align:right;color:#10b981;font-weight:600;">R$ {{ number_format($totalVenda, 2, ',', '.') }}</td>
