    ...
    <div class="max-w-2xl">
        ...
        <form wire:submit="processar">
            ...
            <div class="mt-4 flex gap-3">
                ...
                <x-filament::button type="button" wire:click="reprocessarSubsidios" wire:loading.attr="disabled" color="warning">
                    <span wire:loading.remove wire:target="reprocessarSubsidios">🔄 Reprocessar Subsídios</span>
                    <span wire:loading wire:target="reprocessarSubsidios" class="flex items-center gap-2">
                        <svg class="animate-spin h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                            <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z"></path>
                        </svg>
