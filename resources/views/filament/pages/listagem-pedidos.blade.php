    ...
    <div class="space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-6 border border-gray-200 dark:border-gray-700">
            <div class="grid grid-cols-1 md:grid-cols-6 gap-4 items-end">
                <div>
                    <label class="block text-sm font-medium text-white mb-1">Período</label>
                ...
                <div x-show="$wire.periodo === 'customizado'">
                    <label class="block text-sm font-medium text-white mb-1">De</label>
                ...
                <div x-show="$wire.periodo === 'customizado'">
                    <label class="block text-sm font-medium text-white mb-1">Até</label>
                ...
                <div>
                    <label class="block text-sm font-medium text-white mb-1">Canal</label>
                ...
                <div>
                    <label class="block text-sm font-medium text-white mb-1">Conta</label>
                ...
                <div>
                    <label class="block text-sm font-medium text-white mb-1">Situação Bling</label>
                    <div class="flex flex-wrap gap-2 mt-1">
                        @foreach(['Em aberto', 'Verificado', 'Em andamento', 'Enviado', 'Atendido', 'Entregue', 'Cancelado', 'Faturado – Pendente de Cotação', 'Em Cotação', 'ML Etiqueta', 'Shopee Xpress', 'Lançado Envio'] as $sit)
                            <label class="inline-flex items-center gap-1 text-xs text-white cursor-pointer">
