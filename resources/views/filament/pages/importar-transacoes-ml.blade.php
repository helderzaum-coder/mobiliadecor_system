<x-filament-panels::page>
    <div class="space-y-6">
        ...
        <div class="bg-blue-50 dark:bg-blue-950 border border-blue-200 dark:border-blue-800 rounded-xl p-4 text-sm text-blue-700 dark:text-blue-300">
            <strong>Como usar:</strong> Na planilha do Mercado Livre, selecione a coluna A (datas), copie e cole no campo Datas.
            Repita para a coluna F (descrições) e coluna H (valores debitados). Não precisa formatar nada.
        </div>
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                            @foreach ($this->preview as $linha)
                                ...
                                <tr class="{{ $ok ? '' : 'bg-red-50 dark:bg-red-950' }}">
                                    ...
                                    <td class="px-4 py-2 text-right {{ $linha['valor'] > 0 ? 'text-red-600' : 'text-gray-400' }}">
