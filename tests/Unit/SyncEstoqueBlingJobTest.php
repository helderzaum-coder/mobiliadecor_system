...
{
    public function test_saida_usa_endpoint_estoques_com_operacao_s(): void
    {
        ...
        $this->assertSame('S', $client->calls[0]['body']['operacao']);
        $this->assertSame(2, $client->calls[0]['body']['quantidade']);
    }
