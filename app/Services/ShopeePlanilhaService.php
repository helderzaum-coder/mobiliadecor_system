...
class ShopeePlanilhaService
{
    ...
    private static function calcularPedido(array $linhas, array $mapa): array
    {
        ...
        // total_produtos = preco bruto - cupom Shopee (AG)
        // subsidio_pix fica no campo separado e NAO reduz total_produtos
        // cupom_vendedor fica separado — sai da margem mas nao do subtotal
        $totalPedido = ($precosProduto - $cupomShopee) + $frete;

        return [
            'total_produtos' => round($precosProduto - $cupomShopee, 2),
